...
const Svg = ({ viewBox, children, color, title }: { viewBox?: string; children: React.ReactNode; color?: string; title?: string }) => (
  <svg viewBox={viewBox || "0 0 24 24"} className="h-8 w-8" fill={color || "currentColor"} xmlns="http://www.w3.org/2000/svg" role="img" aria-label={title || "Brand icon"}>
    {title && <title>{title}</title>}
    {children}
  </svg>
);

const LetterIcon = ({ letter, color, title }: { letter: string; color: string; title: string }) => (
  <Svg viewBox="0 0 24 24" color={color} title={title}>
...
const BingIcon = () => (
  <Svg viewBox="0 0 24 24" color="#008373" title="Bing Places for Business">
    <path d="M4.8 3.6v16.8L12 24l7.2-4.8V12l-3.6 2.4-2.4-1.2V7.2L9.6 4.8l-4.8-1.2z"/>
  </Svg>
);

const AppleBusinessIcon = () => (
  <Svg viewBox="0 0 24 24" color="#555555" title="Apple Business Connect">
...
const YelpIcon = () => (
  <Svg viewBox="0 0 24 24" color="#D32323" title="Yelp">
...
const FoursquareIcon = () => (
  <Svg viewBox="0 0 24 24" color="#F94877" title="Foursquare">
...
const HotfrogIcon = () => (
  <LetterIcon letter="H" color="#E8762D" title="Hotfrog" />
);

const BrownbookIcon = () => (
  <LetterIcon letter="B" color="#8B4513" title="Brownbook" />
);

const MantaIcon = () => (
  <Svg viewBox="0 0 24 24" color="#0077B6" title="Manta">
...
const YellowPagesIcon = () => (
  <LetterIcon letter="YP" color="#DAA520" title="Yellow Pages" />
);

const MerchantCircleIcon = () => (
  <LetterIcon letter="MC" color="#1E88E5" title="MerchantCircle" />
);

const BBBIcon = () => (
  <Svg viewBox="0 0 24 24" color="#003B71" title="BBB">
...
const EZlocalIcon = () => (
  <LetterIcon letter="EZ" color="#2E7D32" title="EZlocal" />
);

const ShowMeLocalIcon = () => (
  <LetterIcon letter="S" color="#FF6F00" title="ShowMeLocal" />
);

const CylexIcon = () => (
  <LetterIcon letter="C" color="#00ACC1" title="Cylex" />
);

const CitySquaresIcon = () => (
  <LetterIcon letter="CS" color="#7B1FA2" title="CitySquares" />
);

const ChamberIcon = () => (
  <LetterIcon letter="CC" color="#C62828" title="ChamberofCommerce" />
);

const NextdoorIcon = () => (
  <Svg viewBox="0 0 24 24" color="#8ED500" title="Nextdoor">
...
const AngiIcon = () => (
  <Svg viewBox="0 0 24 24" color="#F55B2D" title="Angi">
...
const SitejabberIcon = () => (
  <LetterIcon letter="SJ" color="#635AD9" title="Sitejabber" />
);

const FindLocalIcon = () => (
  <LetterIcon letter="2F" color="#1565C0" title="2FindLocal" />
);

const WhoDoYouIcon = () => (
  <LetterIcon letter="W" color="#6A1B9A" title="WhoDoYou" />
);

const SpokeIcon = () => (
  <LetterIcon letter="S" color="#00897B" title="Spoke" />
);

const BirdeyeIcon = () => (
  <LetterIcon letter="B" color="#217AC0" title="Birdeye" />
);

const ClutchIcon = () => (
  <Svg viewBox="0 0 24 24" color="#FF3C00" title="Clutch">
...
const GoodFirmsIcon = () => (
  <Svg viewBox="0 0 24 24" color="#3F51B5" title="GoodFirms">
...
const HoneyHatIcon = () => (
  <LetterIcon letter="H" color="#FFB300" title="HoneyHat" />
);

const DesignRushIcon = () => (
  <Svg viewBox="0 0 24 24" color="#00BFA5" title="DesignRush">
    <path d="M12 2L2 7v10l10 5 10-5V7l-10-5zm0 2.21l6.36 3.18L12 10.57 5.64 7.39 12 4.21zM4 9.61l7 3.5v6.68l-7-3.5V9.61zm16 0v6.68l-7 3.5v-6.68l7-3.5z"/>
  </Svg>
);

const UpCityIcon = () => (
  <LetterIcon letter="U" color="#651FFF" title="UpCity" />
);

const ManifestIcon = () => (
  <LetterIcon letter="TM" color="#37474F" title="The Manifest" />
);

const AgencySpotterIcon = () => (
  <LetterIcon letter="AS" color="#E91E63" title="Agency Spotter" />
);

const ExpertiseIcon = () => (
  <LetterIcon letter="E" color="#009688" title="Expertise.com" />
);

const SelectedFirmsIcon = () => (
  <LetterIcon letter="SF" color="#FF6F00" title="SelectedFirms" />
);

const SortlistIcon = () => (
  <LetterIcon letter="S" color="#0055FF" title="Sortlist" />
);
